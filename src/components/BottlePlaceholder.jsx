...
export default function BottlePlaceholder({ nombre, color = '#26262e', tipo = 'botella' }) {
  if (tipo === 'lata') {
    ...
    >
      <defs>
        <linearGradient id={idGrad} x1="0" x2="1" y1="0" y2="0">
          ...
          <stop offset="65%" stopColor="#141418" />
      ...
      {/* cuello */}
      <rect x="86" y="20" width="28" height="55" rx="4" fill={`url(#${idGrad})`} stroke="#e5b96a" strokeOpacity="0.25" />
      {/* tapa */}
      <rect x="82" y="10" width="36" height="18" rx="3" fill="#e5b96a" />
      <rect x="82" y="10" width="36" height="6" rx="3" fill="#f2dca0" />
